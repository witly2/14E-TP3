...
namespace CineQuebec.WindowsTests.FilmTests
{
    ...
    public class FilmServiceTests
    {
        ...
        public async Task GetFilms_Success()
        {
            ...
            Film film1 = new Film("Inception", "Inception", "Un voleur qui entre dans les r�ves des autres pour voler leurs secrets de leur subconscient.", 148, new DateTime(2010, 7, 16), 8);
            Film film2 = new Film("The Dark Knight", "Le Chevalier Noir", "Lorsque la menace connue sous le nom du Joker s�me le chaos parmi les habitants de Gotham, Batman doit accepter l'une des plus grandes �preuves psychologiques et physiques de sa capacit� � lutter contre l'injustice.", 152, new DateTime(2008, 7, 18), 9);
        ...
        {
            Film addedFilm = new Film("Inception", "Inception", "Un voleur qui entre dans les r�ves des autres pour voler leurs secrets de leur subconscient.",
                                    148, new DateTime(2010, 7, 16), 8);
            Film expectedFilm = new Film("Inception", "Inception", "Un voleur qui entre dans les r�ves des autres pour voler leurs secrets de leur subconscient.",
                                    148, new DateTime(2010, 7, 16), 8);
        ...
        {
            Film updatedFilm = new Film("Inception", "Inception", "Un voleur qui entre dans les r�ves des autres pour voler leurs secrets de leur subconscient.",
                                    148, new DateTime(2010, 7, 16), 8);
            Film expectedFilm = new Film("Inception", "Inception", "Un voleur qui entre dans les r�ves des autres pour voler leurs secrets de leur subconscient.",
                                    148, new DateTime(2010, 7, 16), 8);
